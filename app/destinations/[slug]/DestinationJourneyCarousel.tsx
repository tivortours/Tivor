  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        className={`absolute left-0 top-1/2 z-10 -translate-x-6 -translate-y-1/2 cursor-pointer transition-opacity duration-300 sm:-translate-x-7 lg:-translate-x-10 xl:-translate-x-12 ${
      ...
      <button
        ...
        className={`absolute right-0 top-1/2 z-10 translate-x-6 -translate-y-1/2 cursor-pointer transition-opacity duration-300 sm:translate-x-7 lg:translate-x-10 xl:translate-x-12 ${
