    ...
    <>
      <div className="relative">
        ...
        <button
          ...
          className={`absolute cursor-pointer left-0 top-1/2 z-10 -translate-x-5 -translate-y-1/2 transition-opacity duration-300 sm:-translate-x-7 lg:-translate-x-10 xl:-translate-x-12 rounded-full bg-white/40 text-black shadow-sm disabled:opacity-25 ${
        ...
        <button
          ...
          className={`absolute cursor-pointer right-0 top-1/2 z-10 translate-x-5 -translate-y-1/2 transition-opacity duration-300 sm:translate-x-7 lg:translate-x-10 xl:translate-x-12 rounded-full bg-white/40 text-black shadow-sm disabled:opacity-25 ${
