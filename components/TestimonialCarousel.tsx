  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        className={`absolute left-0 top-1/2 -translate-x-1/2 -translate-y-1/2 flex h-11 w-11 items-center justify-center rounded-full border border-[#cfbcad] bg-white text-[#151515] transition-all duration-300 hover:bg-[#151515] hover:text-white ${
      ...
      <button
        ...
        className={`absolute right-0 top-1/2 translate-x-1/2 -translate-y-1/2 flex h-11 w-11 items-center justify-center rounded-full border border-[#cfbcad] bg-white text-[#151515] transition-all duration-300 hover:bg-[#151515] hover:text-white ${
