    ...
    <div className="relative">
      ...
      {canScrollLeft && arrowTop > 0 && (
        <button
          ...
          className="absolute cursor-pointer left-0 z-10 -translate-x-7 sm:-translate-x-7 lg:-translate-x-10 xl:-translate-x-12 -translate-y-1/2"
          style={{ top: arrowTop }}
        >
      ...
      {canScrollRight && arrowTop > 0 && (
        <button
          ...
          className="absolute cursor-pointer right-0 z-10 translate-x-7 sm:translate-x-7 lg:translate-x-10 xl:translate-x-12 -translate-y-1/2"
          style={{ top: arrowTop }}
        >
          <svg width="28" height="28" viewBox="0 0 28 28" fill="none" aria-hidden="true">
